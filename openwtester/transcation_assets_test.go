...
func TestTransfer(t *testing.T) {
	...
	walletID := "WNHZ9GktKP5ZHRCeuemfhESR8X9jBiLoMR"
	accountID := "5bsJ8R5xMLVAPY1dQ1bpqtbW6y9qvWU6mHJo2nMk2WiR"
	to := "epc1txn8ku0p638v7cpmrc6ngmgv5eqhv603glp32f"
...
func getdata(addr string) {
	c := epchian.NewClient("http://47.112.139.225:20001", false)
